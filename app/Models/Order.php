...
class Order extends Model
{
    ...
    {
        return ['status' => OrderStatus::class, 'shipping_address' => 'array', 'subtotal' => 'integer', 'shipping_fee' => 'integer', 'total' => 'integer', 'expires_at' => 'immutable_datetime', 'paid_at' => 'immutable_datetime'];
    }
